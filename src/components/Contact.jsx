          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              {[
                {
                  icon: <AiFillGithub />,
                  href: "https://github.com/Praneeth1136",
                  label: "GitHub",
                },
                {
                  icon: <AiFillLinkedin />,
                  href: "https://www.linkedin.com/in/praneeth-986bab325/",
                  label: "LinkedIn",
                },
                {
                  icon: <AiOutlineMail />,
                  href: "Praneethkilaparthi@gmail.com",
                  label: "Email",
                },
              ].map((social, index) => (
                <motion.a

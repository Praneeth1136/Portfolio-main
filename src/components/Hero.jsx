        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-14 lg:gap-48 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-4">
              <motion.a
                href="/RRESUME.pdf" // Ensure this matches your actual file name
                target="_blank"
              ...
              <div className="flex gap-3">
                <motion.a
                  href="https://github.com/Praneeth1136" // Replace with your GitHub URL
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <motion.a
                  href="https://www.linkedin.com/in/praneeth-986bab325/" // Replace with your LinkedIn URL
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 border border-purple-600 rounded-lg hover:bg-purple-600/10 transition-all group"
                  whileHover={{
          ...
          >
            ...
            >
              ...
              <motion.img
                src="PORTFOLIO PIC.jpg" // Ensure this path is correct
                alt="Profile"
